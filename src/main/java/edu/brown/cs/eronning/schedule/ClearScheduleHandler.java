...
public class ClearScheduleHandler implements Route{
  
  private ServerData serverData;
  private static final Gson GSON = new Gson();
  
  public ClearScheduleHandler(ServerData serverData) {
  ...
  public Object handle(final Request req, final Response res) {
    ...
    try {
      ...
      Map<Show, TimeBlock> blankSchedule = new HashMap<Show, TimeBlock>();
      currUser.setSchedule(blankSchedule);
      
      response = ImmutableMap.of("title", "emptyResponse");
